...
const cargarUsuarios = async () => {
    try {
        const respuesta = await fetch('/montoya_final_dotacion_ingsoft/usuario/buscarAPI');
...
const cargarAplicaciones = async () => {
    try {
        const respuesta = await fetch('/montoya_final_dotacion_ingsoft/aplicacion/buscarAPI');
        const data = await respuesta.json();
...
const cargarPermisos = async () => {
    try {
        ...
        let url = '/montoya_final_dotacion_ingsoft/permiso/buscarAPI?';
        const params = [];
...
const GuardarAsignacion = async (event) => {
    ...
    const url = '/montoya_final_dotacion_ingsoft/asignacion_permiso/guardarAPI';
...
const BuscarAsignaciones = async () => {
    const url = '/montoya_final_dotacion_ingsoft/asignacion_permiso/buscarAPI';
    try {
...
const aplicarFiltrosTabla = () => {
    ...
    let url = '/montoya_final_dotacion_ingsoft/asignacion_permiso/buscarAPI?';
    const params = [];
...
const ModificarAsignacion = async (event) => {
    ...
    const body = new FormData(FormularioAsignaciones);
    const url = '/montoya_final_dotacion_ingsoft/asignacion_permiso/modificarAPI';
...
const EliminarAsignacion = async (e) => {
    ...
    if (confirmar.isConfirmed) {
        const url = `/montoya_final_dotacion_ingsoft/asignacion_permiso/eliminar?id=${id}`;
        try {
            const res = await fetch(url);
