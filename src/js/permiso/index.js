...
const GuardarPermiso = async (event) => {
    ...
    const url = '/montoya_final_dotacion_ingsoft/permiso/guardarAPI';
...
const BuscarPermisos = async () => {
    const url = '/montoya_final_dotacion_ingsoft/permiso/buscarAPI';
    try {
...
const ModificarPermiso = async (event) => {
    ...
    const body = new FormData(FormularioPermisos);
    const url = '/montoya_final_dotacion_ingsoft/permiso/modificarAPI';
...
const EliminarPermiso = async (e) => {
    ...
    if (confirmar.isConfirmed) {
        const url = `/montoya_final_dotacion_ingsoft/permiso/eliminar?id=${id}`;
        try {
            const res = await fetch(url);
