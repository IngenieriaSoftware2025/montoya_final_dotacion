...
const GuardarAplicacion = async (event) => {
    ...
    const url = '/montoya_final_dotacion_ingsoft/aplicacion/guardarAPI';
...
const BuscarAplicaciones = async () => {
    const url = '/montoya_final_dotacion_ingsoft/aplicacion/buscarAPI';
    try {
...
const ModificarAplicacion = async (event) => {
    ...
    const body = new FormData(FormularioAplicaciones);
    const url = '/montoya_final_dotacion_ingsoft/aplicacion/modificarAPI';
...
const EliminarAplicacion = async (e) => {
    ...
    if (confirmar.isConfirmed) {
        const url = `/montoya_final_dotacion_ingsoft/aplicacion/eliminar?id=${id}`;
        try {
            const res = await fetch(url);
