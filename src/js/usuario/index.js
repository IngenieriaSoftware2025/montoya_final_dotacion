...
const GuardarUsuario = async (event) => {
    ...
    const url = '/montoya_final_dotacion_ingsoft/usuario/guardarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const BuscarUsuarios = async () => {
    const url = '/montoya_final_dotacion_ingsoft/usuario/buscarAPI';
    const config = {
        method: 'GET'
    }
...
const llenarFormulario = async (event) => {
    ...
    const url = `/montoya_final_dotacion_ingsoft/usuario/buscarAPI?id=${usuarioId}`;
    const config = {
        method: 'GET'
    }
...
const ModificarUsuario = async (event) => {
    ...
    const body = new FormData(FormularioUsuarios);
    const url = '/montoya_final_dotacion_ingsoft/usuario/modificarAPI';
    const config = {
        method: 'POST',
        body
    }
...
const EliminarUsuarios = async (e) => {
    ...
    if (AlertaConfirmarEliminar.isConfirmed) {
        const url = `/montoya_final_dotacion_ingsoft/usuario/eliminar?id=${idUsuario}`;
        const config = {
            method: 'GET'
        }
        ...
        { 
            ...
            render: (data, type, row) => {
                if (data && data.trim() !== '') {
                    ...
                    const imageUrl = `/montoya_final_dotacion_ingsoft/storage/fotos_usuarios/${data}`;
